...
public class ModelNames {
        // Use a different graph from kb-2 to avoid wiping out local portal edits during publish
	public static final String ABOX_ASSERTIONS = "http://vitro.mannlib.cornell.edu/default/vitro-kb-adminapp";
