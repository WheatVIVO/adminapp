...
implements ModelChangedListener, ChangeListener {
    ...
    /**
     * RAP refactoring: a separate method for registering the change listener
     * WheatVIVO : this is necessary for the IndexingInferenceService
     */
    ...
    /**
     * Report whether this reasoner object is registered to listen for data changes
    ...
    /**
     * RAP refactoring: a separate method for unregistering the listener from changes
     * WheatVIVO : this is necessary for the IndexingInferenceService
     */
    public void unregisterChangeListener() {
        if (rdfService == null) {
            aboxModel.unregister(this);
            this.isRegistered = true;
        } else {
            try {
                rdfService.unregisterListener(this);
            } catch (RDFServiceException e) {
                throw new RuntimeException("Unable to unregister change listener", e);
            }
        } 
