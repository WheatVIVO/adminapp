...
$(document).ready(function(){
    ...
    $.each($('.propertyTabsList > li'), function() {
        var groupName = $(this).attr("groupName");
        var $propertyGroupLi = $(this);

        $(this).click(function() {

            if ( $propertyGroupLi.hasClass("nonSelectedGroupTab") ) {
                $('.selectedGroupTab').removeClass('selectedGroupTab').addClass('nonSelectedGroupTab');
                $propertyGroupLi.removeClass("nonSelectedGroupTab");
                $propertyGroupLi.addClass("selectedGroupTab");
            }
