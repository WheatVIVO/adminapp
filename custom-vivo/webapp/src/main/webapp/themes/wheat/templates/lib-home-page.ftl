...
<#macro facultyMbrHtml>
    <section id="home-faculty-mbrs" class="home-sections pa3" >
        <h4 class="tc f4 pa2 mb3">${i18n().faculty_capitalized}</h4>
        <div id="tempSpacing">
...
<#macro allClassGroups classGroups>
    ...
    <#assign classGroupList>
        <section id="home-stats" class="home-sections pa3 w-50-l" >
            <h4 class="tc f4 pa2 mb3">${i18n().statistics}</h4>
            <ul id="stats" class="flex flex-wrap justify-around">
                <#assign groupCount = 1>
                <#list classGroups as group>
                    <#if (groupCount > 6) >
                        <#break/>
...
<#assign foundClassGroup = false />
<section id="home-research" class="home-sections pa3">
    <h4 class="tc f4 pa2 mb3">${i18n().research_capitalized}</h4>
    <ul>
        <#list classGroups as group>
...
<#macro academicDeptsHtml>
    <section id="home-academic-depts" class="home-sections pa3">
        <h4 class="tc f4 pa2 mb3">${i18n().departments}</h4>
...
<#macro geographicFocusHtml>
    <section id="home-geo-focus" class="home-sections dn db-l mb4 fr-l w-two-thirds-l">
